...
namespace lab9
{
    class ReaderPro : Reader
    {
        ...
        public ReaderPro(string Status, int ReaderID, string Surname, string Name, string Patronymic, string Gender, string Phone)  : base (ReaderID, Surname, Name, Patronymic, Gender, Phone)
        {
            this.Status = Status;
            st = 1;
        }
